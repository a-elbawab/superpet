...
return [
    ...
    'shipping_notes' => [
        'inside_alexandria' => "داخل الإسكندرية:\n\nيتم توصيل الطلب خلال ساعة واحدة إذا تم الطلب قبل الساعة 9 مساءً.\nأما الطلبات بعد الساعة 9 مساءً فيتم توصيلها في اليوم التالي.",
        'outside_alexandria' => "خارج الإسكندرية:\n\nيتم التوصيل خلال 4 إلى 7 أيام عمل حسب شركة الشحن.",
        'title' => 'ملاحظات الشحن',
    ],
];
