            ...
            @component('dashboard::components.box')
                ...
                <table class="table table-striped table-middle">
                    <tbody>
                        ...
                        <tr>
                            <th width="200">@lang('feedback.attributes.created_at')</th>
                            <td>{{ $feedback->present()->created_at }}</td>
                        </tr>
                        <tr>
                            <th width="200">@lang('feedback.attributes.type')</th>
                            <td>{{ $feedback->present()->type }}</td>
                        </tr>
                        <tr>
