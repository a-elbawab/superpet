<x-layout :title="trans('tags.trashed')" :breadcrumbs="['dashboard.tags.trashed']">
    ...
    @component('dashboard::components.table-box')
        ...
        <tr>
          <th colspan="100">
            <x-check-all-force-delete
                    ...
                    :resource="trans('tags.plural')"></x-check-all-force-delete>
            <x-check-all-restore
                    type="{{ \App\Models\Tag::class }}"
                    :resource="trans('tags.plural')"></x-check-all-restore>
          </th>
        </tr>
        <tr>
        ...
        @forelse($tags as $tag)
            <tr>
                ...
                <td>
                    <a href="{{ route('dashboard.tags.trashed.show', $tag) }}"
