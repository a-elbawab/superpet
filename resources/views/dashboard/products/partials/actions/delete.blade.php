@can('delete', $product)
    <a href="#product-{{ $product->id }}-delete-model" class="btn btn-outline-danger btn-sm" data-toggle="modal">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    {{ BsForm::delete(route('dashboard.products.destroy', [$product, 'page' => request('page')])) }}
