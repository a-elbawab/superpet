<x-layout :title="trans('galleries.plural')" :breadcrumbs="['dashboard.galleries.index']">
    ...
    @component('dashboard::components.table-box')
          ...
          <th colspan="100">
            <div class="d-flex">
                <x-check-all-delete
                        ...
                        :resource="trans('galleries.plural')"></x-check-all-delete>

                <div class="ml-2 d-flex justify-content-between flex-grow-1">
                    @include('dashboard.galleries.partials.actions.create')
                    @include('dashboard.galleries.partials.actions.trashed')
                </div>
            </div>
          </th>
        </tr>
        <tr>
            ...
            <th>@lang('galleries.attributes.image')</th>
                ...
                <td>
                    <a href="{{ route('dashboard.galleries.show', $gallery) }}"
                       class="text-decoration-none text-ellipsis">
                        ...
                        <img src="{{ $gallery->getFirstMediaUrl('image') }}"
                             alt="Image"
