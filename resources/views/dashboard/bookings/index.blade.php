          ...
          <th colspan="100">
            <div class="d-flex">
                <x-check-all-delete
                        ...
                        :resource="trans('bookings.plural')"></x-check-all-delete>

                <div class="ml-2 d-flex justify-content-between flex-grow-1">
                    @include('dashboard.bookings.partials.actions.create')
                    @include('dashboard.bookings.partials.actions.trashed')
                </div>
            </div>
          </th>
        </tr>
