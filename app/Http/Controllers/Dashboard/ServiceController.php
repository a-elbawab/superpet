...
class ServiceController extends Controller
{
    ...
    {
        $services = Service::filter()->orderBy('order')->paginate();
    ...
    public function store(ServiceRequest $request)
    {
        ...
        $service->addAllMediaFromTokens($request->input('image'));
        $service->addAllMediaFromTokens($request->input('home_icon'));
    ...
    {
        $sections = $service->sections()->filter()->latest()->paginate();
        return view('dashboard.services.show', compact('service', 'sections'));
    }
    ...
    public function sort(Request $request)
    {
        foreach ($request->order as $item) {
            Service::where('id', $item['id'])->update(['order' => $item['position']]);
        }
