...
class ProductPolicy
{
    ...
    {
        return $user->isAdmin() || $user->hasPermissionTo('Products list');
    }
    ...
    {
        return $user->isAdmin() || $user->hasPermissionTo('Products show');
    }
    ...
    {
        return $user->isAdmin() || $user->hasPermissionTo('Products create');
    }
    ...
    {
        return ($user->isAdmin() || $user->hasPermissionTo('Products update'))
    ...
    {
        return ($user->isAdmin() || $user->hasPermissionTo('Products delete'))
            && ! $this->trashed($product);
    }
