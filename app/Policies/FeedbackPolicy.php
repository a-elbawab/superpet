...
class FeedbackPolicy
{
    ...
    {
        return $user->isAdmin() || $user->hasPermissionTo('Feedbacks list');
    }
    ...
    {
        return $user->isAdmin() || $user->hasPermissionTo('Feedbacks show');
    }
    ...
    {
        return $user->isAdmin() || $user->hasPermissionTo('Feedbacks delete');
    }
}
