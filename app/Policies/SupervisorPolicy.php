...
class SupervisorPolicy
{
    ...
    {
        return $user->isAdmin() || $user->hasPermissionTo('Supervisors list');
    }
    ...
    {
        return $user->isAdmin() || $user->is($supervisor) || $user->hasPermissionTo('Supervisors show');
    }
    ...
    {
        return $user->isAdmin() || $user->hasPermissionTo('Supervisors create');
    }
    ...
    {
        return (($user->isAdmin() || $user->is($supervisor)) || $user->hasPermissionTo('Supervisors update')) && ! $this->trashed($supervisor);
    }
    ...
    {
        return ($user->isAdmin() || $user->is($supervisor)) || $user->hasPermissionTo('Supervisors update');
    }
    ...
    {
        return ($user->isAdmin() && $user->isNot($supervisor) || $user->hasPermissionTo('Supervisors delete')) && ! $this->trashed($supervisor);
    }
    ...
    {
        return ($user->isAdmin() || $user->hasPermissionTo('Supervisors delete')) && $this->hasSoftDeletes();
    }
    ...
    {
        return ($user->isAdmin() || $user->hasPermissionTo('Supervisors delete')) && $this->trashed($supervisor);
    }
